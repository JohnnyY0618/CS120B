...
int main(void) {
	...
	while (1) {
		...
		if ( (tmpA & 0x0F) <= 4 ) { // true if fuel leve is 4 or less
			tmpC = tmpC | 0x40; // set PC6 to 1, 0100 0000
		}

		// light PC7 if driver not fasten seatbelt
		if ((tmpA & 0x70) == 0x30) { // if true !PA6 & PA5 & PA4 (0011 0000)
			tmpC = tmpC | 0x80; // set PC7 to 1, 1000 0000
		}
