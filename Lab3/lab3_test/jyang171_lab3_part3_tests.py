...
tests = [ {'description': '(15)PINA: 0x0F, => (63)PORTC: 0x3F',
    'steps': [ {'inputs': [('PINA',0x0F)], 'iterations': 5 } ],
    'expected': [('PORTC',0x3F)],
    },
    {'description': '(0)PINA: 0x00, => (63)PORTC: 0x40',
    'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 5 } ],
    'expected': [('PORTC',0x40)],
    },
    {'description': '(1111 1100)PINA: 0xFC, => (0011 1110)PORTC: 0x3E',
    'steps': [ {'inputs': [('PINA',0xFC)], 'iterations': 5 } ],
    'expected': [('PORTC',0x3E)],
    },
    {'description': '(0011 1100)PINA: 0x3C, => (1011 1110)PORTC: 0xBE',
    'steps': [ {'inputs': [('PINA',0xFC)], 'iterations': 5 } ],
    'expected': [('PORTC',0x3E)],
    },
    ]
