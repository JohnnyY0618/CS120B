...
tests = [ {'description': '(15)PIND: 0x0F,PINB: 0x01 => PORTB: 0x04',
    'steps': [ {'inputs': [('PIND',0x0F),('PINB',0x01)], 'iterations': 5 } ],
    'expected': [('PORTB',0x04)],
    },
    {'description': '(80)PIND: 0x50,PINB: 0x00 => PORTB: 0x02',
    'steps': [ {'inputs': [('PIND',0x50),('PINB',0x00)], 'iterations': 5 } ],
    'expected': [('PORTB',0x02)],
    },
    ...
    {'description': 'PIND: 0xB4,PINB: 0x01 => PORTB: 0x00',
    'steps': [ {'inputs': [('PIND',0xB4),('PINB',0x01)], 'iterations': 5 } ],
    'expected': [('PORTB',0x02)],
    },
    ]
#watch = ['PORTB']
