...
tests = [ {'description': '(0000 1111)PINA: 0x0F, => PORTB: 0x00, PORTC: 0xF0',
    'steps': [ {'inputs': [('PINA',0x0F)], 'iterations': 5 } ],
    'expected': [('PORTB',0x00),('PORTC',0xF0)],
    },
    {'description': 'PINA: 0x38, => PORTB: 0x03, PORTC: 0x80',
    'steps': [ {'inputs': [('PINA',0x38)], 'iterations': 5 } ],
    'expected': [('PORTB',0x03),('PORTC',0x80)],
    },
    {'description': 'PINA: 0x60, => PORTB: 0x06, PORTC: 0x00',
    'steps': [ {'inputs': [('PINA',0x60)], 'iterations': 5 } ],
    'expected': [('PORTB',0x06),('PORTC',0x00)],
    },
    ]
#watch = ['PORTB'],['PORTC']
