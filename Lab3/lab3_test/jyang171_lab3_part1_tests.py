...
tests = [ {'description': '(15)PINA: 0x0F, (0)PINB: 0x00 => (0)PORTC: 0x04',
    'steps': [ {'inputs': [('PINA',0x0F), ('PINB',0x00)], 'iterations': 5 } ],
    'expected': [('PORTC',0x04)],
    },
    {'description': '(0)PINA: 0x00, (252)PINB: 0xFC => (6)PORTC: 0x06',
    'steps': [ {'inputs': [('PINA',0x00), ('PINB',0xFC)], 'iterations': 5 } ],
    'expected': [('PORTC',0x06)],
    },
    {'description': '(120)PINA: 0x78, (86)PINB: 0x56 => (8)PORTC: 0x08',
    'steps': [ {'inputs': [('PINA',0x78), ('PINB',0x56)], 'iterations': 5 } ],
    'expected': [('PORTC',0x08)],
    },
    {'description': '(0)PINA: 0x00, (86)PINB: 0x00 => (0)PORTC: 0x00',
