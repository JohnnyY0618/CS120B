 ...
 *  Partner(s) Name:
 *	Lab Section:
 *	Assignment: Lab #11  Final Project: Pong Game- "Advancement‌ ‌1‌ "
...
enum O_States {O_Start,O_init,O_play1, O_play2, O_Ball, O_PauseDisplay, O_reset, O_resetR};
